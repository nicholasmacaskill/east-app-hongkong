...
// Test database connection from .env.test
...
async function run() {
    try {
        ...
        console.log('Connected to TEST database (lzqnviblkcnjsxutqeht)');
        ...
        console.log('✅ coach_drills and coach_drill_steps created in TEST database');
