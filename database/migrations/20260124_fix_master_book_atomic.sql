-- Migration: Fix Master Booking Atomicity
-- Removes references to non-existent 'attendee_id' column
-- Properly maps v_attendee_id to user_id (the attendee)
-- Properly maps p_user_id to payer_id (the payer)
