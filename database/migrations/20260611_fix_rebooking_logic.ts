...
async function runMigration() {
  console.log('🚀 Migration: Fix Rebooking Logic (ON CONFLICT)');

  const sql = `
-- 2. Update master_book_atomic to handle rebooking of cancelled sessions
...
`;
  ...
  if (error) {
    ...
    console.log('✅ Success: master_book_atomic updated to handle ON CONFLICT rebooking.');
  }
}
