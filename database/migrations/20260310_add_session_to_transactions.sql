-- Migration: Add session_id to transactions and update logging
-- Date: 2026-03-10
...
-- 2. Update master_book_atomic to populate session_id in transaction log
...
BEGIN
  ...
  -- 11. LOG TRANSACTION (NOW populating session_id)
