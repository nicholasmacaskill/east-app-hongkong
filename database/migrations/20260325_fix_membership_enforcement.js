...
// Manual dotenv loading for robustness
function loadEnv() {
...
async function runMigration() {
    ...
    const sql = `
-- 0. Drop old function signatures to prevent overloading ambiguity
...
BEGIN
  ...
  IF (v_user_sub_status IS NULL OR v_user_sub_status NOT IN ('active', 'trialing'))
    ...
    RETURN jsonb_build_object(
      'success', false, 
      'message', 'Account Locked: Active membership required to book. Please purchase a membership (individual or family) first.', 
