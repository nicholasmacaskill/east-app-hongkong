            ...
            <div className="w-full max-w-sm bg-white/[0.03] backdrop-blur-xl rounded-[2.5rem] p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 animate-fadeIn relative z-10 overflow-hidden">
                ...
                {step === 'login' && (
                    <>
                        ...
                        {expectedRole !== 'admin' && expectedRole !== 'sys-admin' && expectedRole !== 'coach' && (
                            <>
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 text-white/70 hover:text-white font-bold text-sm py-4 rounded-2xl transition-all duration-300 disabled:opacity-50 active:scale-95"
                                >
                                    {googleLoading ? (
                                        <span className="inline-block w-4 h-4 rounded-full border border-white/30 border-t-white animate-spin" />
                                    ) : (
