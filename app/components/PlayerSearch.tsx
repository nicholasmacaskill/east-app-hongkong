  ...
  return (
    <div className={`relative w-full max-w-xl mx-auto ${className}`} data-testid="player-search">
      ...
      <input
        ...
        className="w-full bg-[#111] border-2 border-east-light/40 rounded-full py-4 pl-12 pr-4 text-white font-black italic text-xs uppercase tracking-widest placeholder:text-gray-500 focus:outline-none focus:border-east-light focus:shadow-[0_0_20px_rgba(40,209,96,0.25)] transition-colors"
      />
