                ...
                <div className="space-y-6">
                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                        ...
                        <div className="space-y-4">
                            <a href="mailto:support@eastsportsgroup.com" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold">support@eastsportsgroup.com</p>
                                </div>
                            </a>
                            <a href="tel:+85212345678" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors">
                                <div className="w-10 h-10 rounded-full bg-black flex items-center justify-center border border-white/10">
                                    <Phone size={18} />
                                </div>
                                <div>
                                    <p className="text-[10px] font-bold text-gray-500 uppercase">Call Us</p>
                                    <p className="font-bold">+852 1234 5678</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                        ...
                        <button className="w-full bg-east-light text-black font-black italic py-4 rounded-full uppercase tracking-widest flex items-center justify-center gap-2">
