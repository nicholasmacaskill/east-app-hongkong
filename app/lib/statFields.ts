...
export const STAT_FIELDS: Record<SportCategory, StatField[]> = {
  ...
  FITNESS_TEST: [
    ...
    { key: 'critical_power_max', label: 'Critical Power (Max)', type: 'number', unit: '#' },
    { key: 'critical_power_fatigue', label: 'Critical Power (Fatigue)', type: 'number', unit: '#' },
  ...
  FITNESS_TEST: [
    {
      ...
      emoji: '🏒',
      accent: 'cyan',
      keys: ['on_ice_agility', 'on_ice_agility_with_puck', 'skating', 'critical_power_max', 'critical_power_fatigue'],
    },
    {
      title: 'Speed & Agility',
      emoji: '⚡',
