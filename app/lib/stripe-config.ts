...
export function getStripePriceId(key: string): string {
  ...
  const testPrices: Record<string, string | undefined> = {
    ...
    'TOPUP_STARTER': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_STARTER_TEST,
    'TOPUP_STANDARD': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_STANDARD_TEST,
    'TOPUP_PRO': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_PRO_TEST,
    'TOPUP_ELITE': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_ELITE_TEST,
    'TOPUP_ULTIMATE': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_ULTIMATE_TEST,
    'TOPUP': process.env.NEXT_PUBLIC_STRIPE_PRICE_TOPUP_TEST,
  };
