    ...
    useEffect(() => {
        const fetchProfile = async () => {
            ...
            try {
                ...
                // Map database columns to the format expected by PlayerProfile
                setProfileData({
                    id: data.id,
    ...
    if (error || !profileData) {
        return (
            <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white font-montserrat p-4 text-center">
                ...
                <p className="text-gray-500 uppercase tracking-widest text-xs">The requested player profile could not be loaded.</p>
            </div>
        );
    }
