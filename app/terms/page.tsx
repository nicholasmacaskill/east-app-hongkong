        ...
        <div className="min-h-screen bg-black text-white p-6 pb-32">
            <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/?tab=profile" className="p-2 bg-[#1e1e1e] rounded-lg hover:bg-east-light hover:text-black transition-colors">
                        <ChevronLeft size={20} />
                    </Link>
                ...
                <div className="bg-[#1e1e1e] rounded-3xl p-6 border border-white/5 space-y-6 text-gray-300 text-sm leading-relaxed">
                    ...
                    <div className="pt-8 flex justify-center">
                        <Link href="/?tab=profile" className="text-east-light font-black italic uppercase text-xs hover:underline">
                            Back to Profile
                        </Link>
                    </div>
