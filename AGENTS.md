...
- **Role:** Dedicated Security and Logic Auditor.
- **Workflow:** Type **`@Auditor`** in chat to trigger security review.
- **Focus:** RLS bypasses, permissions (`app/types.ts`), and vulnerabilities.
