;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="ae4ee975-6d86-105c-2fe8-50848bdbf656")}catch(e){}}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([typeof document === "object" ? document.currentScript : undefined,
"[project]/app/admin-ops/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminOpsDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminOpsDashboard.useEffect": ()=>{
            const fetchStats = {
                "AdminOpsDashboard.useEffect.fetchStats": async ()=>{
                    try {
                        // Fetch Coach Count
                        const { count: coachCount } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*', {
                            count: 'exact',
                            head: true
                        }).eq('role', 'coach');
                        // Fetch Service Count (Session Types)
                        const { count: typeCount } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('session_types').select('*', {
                            count: 'exact',
                            head: true
                        });
                        setStats({
                            "AdminOpsDashboard.useEffect.fetchStats": (prev)=>({
                                    ...prev,
                                    coaches: coachCount || 0,
                                    services: typeCount || 0
                                })
                        }["AdminOpsDashboard.useEffect.fetchStats"]);
                    } catch (err) {
...
_s(AdminOpsDashboard, "s0KeM5JPRz3gO3XtU7AuP7HJPtY=");
_c = AdminOpsDashboard;
var _c;
__turbopack_context__.k.register(_c, "AdminOpsDashboard");
...
//# debugId=ae4ee975-6d86-105c-2fe8-50848bdbf656
//# sourceMappingURL=_92fca7a6._.js.map